...
public class JobDesiredFragment extends Fragment {

    private OnPageIntraction mListener;

    public JobDesiredFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_jobdesired, container, false);
        Button button = (Button)view.findViewById(R.id.btn_job);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mListener.gotoPage(1, 0);
            }
        });
        return view;
    }
